  ...
  export default {
    ...
    methods: {
      ...
      getCityList () {
        ...
        //   }
        // })
        if(this.formData.city_name===""&& this.formData.garage_name===""){
          alert("请输入城市或网点")
        }else if(this.formData.city_name === "北京"|| this.formData.garage_name==="aaa"){
          this.dataTable=[{
            id:"1",
            number:"001",
            brand:"xx牌",
            ...
            garage:"aaa",
            status:"已启用",
            updated_at:"2019-5-23",
           
          }]
        }
        this.formData.city_name=""
        this.formData.garage_name=""
      },
      nextPage (page) {

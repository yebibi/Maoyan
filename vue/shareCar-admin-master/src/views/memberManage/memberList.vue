  ...
  <div>
    <Form  :label-width="80">
      <Row :gutter="16">
        ...
        <Col span="6">
          <Form-item label="手机号">
            <Input placeholder="请输入" v-model="phoneNum"></Input>
          </Form-item>
        </Col>
        <Col span="6">
      ...
      <Row :gutter="16">
        ...
        <Col span="6">
            <div>
              ...
              <Button type="success" @click.native="getMenberList">搜索</Button>
            </div>
        </Col>
      </Row>
    </Form>
  ...
  export default {
    ...
    methods: {
      ...
      getMenberList () {
        ...
        if(this.name==="张三" ||this.phoneNum==="18174019119"){
          this.dataTable=[{
            warning:"提醒",
            id:"1",
            sex:"男",
        ...
        }if(this.name==="李四"|| this.phoneNum==="13247001997"){
          this.dataTable=[{
            warning:"提醒",
            id:"1",
            sex:"男",

  ...
  <div>
    ...
    <Form :label-width="80">
      <Row :gutter="16">
        <Col span="6">
          <Form-item label="车牌号">
            <Input placeholder="请输入" v-model="carNum"></Input>
          </Form-item>
        </Col>
        <Col span="6">
        ...
        <Col span="6">
          <Form-item label="使用状态">
            <Select placeholder="请选择" v-model="userState">
              <Option v-for="item in dataTable" :value="item.id" :key="item.id">{{item.use_state}}</Option>
            </Select>
          </Form-item>
        </Col>
        ...
        <Form-item>
          <Button type="info" @click.native="getCarMessageList">查询</Button>
  ...
  export default {
    ...
    methods: {
      ...
      getCarMessageList () {
        ...
        if(this.carNum.indexOf("123456")!= -1){
          this.dataTable=[
            {
              warning:"提醒",
              id:"1",
              ...
              use_state:"未使用",
              electricity:"80%",
              left_mileage:"10000km",
              terminal_state:"已启动",
            }
          ]
          
        }if(this.carNum==="123456"){
          this.dataTable=[
            {
              warning:"提醒",
              id:"1",

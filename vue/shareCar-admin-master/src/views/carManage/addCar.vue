  ...
  <div>
    <Form  :label-width="120">
      ...
      <Row :gutter="16">
        ...
        <Col span="6">
          <Form-item label="检验有效期">
            <Input placeholder="请输入颜色" v-model="formData.check_expire_date"></Input>
      ...
      <Row>
        ...
        <Col span="6">
          <Form-item label="投保日期">
               <Input v-model="formData.TCIStartDate" placeholder="输入日期"></Input>
            <!-- <Date-picker v-model="formData.TCIStartDate" type="date" placeholder="选择日期"></Date-picker> -->
          </Form-item>
        </Col>
        <Col span="6">
          <Form-item label="有效保险期">
            <Input v-model="formData.TCIEndDate" placeholder="输入有效保险期"></Input>
      ...
      <Row>
        ...
        <Col span="6">
          <Form-item label="投保日期">
             <Input v-model="formData.VCIStartDate" placeholder="请输入商业险保单号"></Input>
            <!-- <Date-picker v-model="formData.VCIStartDate" type="date" placeholder="选择日期"></Date-picker> -->
          </Form-item>
        </Col>
        <Col span="6">
          <Form-item label="有效保险期">
             <Input v-model="formData.VCIEndDate" placeholder="请输入商业险保单号"></Input>
...
<script>
  ...
  export default {
    ...
    methods: {
      addCar () {
        if(this.formData.plate==""||this.formData.typeID=="" || this.formData.vinNo==""){
          alert("请输入完整内容")
        }else{
          alert("提交成功")
        }

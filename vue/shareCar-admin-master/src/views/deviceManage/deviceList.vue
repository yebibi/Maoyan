<template>
  <div>
    ...
    <Form :label-width="80">
      ...
      <Row>
        ...
        <Col span="4" offset="4">
          ...
          <Button type="success" @click.native="clear" >清空</Button>
        </Col>
        <Col span="4" offset="3">
    ...
    <Modal v-model="showAdd" title="添加设备" @on-ok="addDeviceList">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addDeviceList () {
        if(this.newData.car_id===""|| this.newData.obd_sn===""||this.newData.operator_id===""){
          alert("请输入完整信息")
        }else{
          this.dataTable.push({
            id:this.newData.car_id,
            sn:this.newData.obd_sn,
            plate:"xxx厂商",
            created_at:"2018-01-02",
            state:"停用",
            operator:this.newData.operator_id,
            operated_at:"25分钟",
          })
        }
